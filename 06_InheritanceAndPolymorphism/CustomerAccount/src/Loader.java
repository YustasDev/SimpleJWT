...
//        }
    ...
    public static void printSelectAccount() {
      System.out.println("Вы можете воспользоваться расчетным счетом для физического лица, юридического лица, ИП. ");
      System.out.println("1) Для физических лиц, пополнение и снятие со счета происходит без комиссии;");
      System.out.println("2) Для юридических лиц, снятие со счета происходит с комиссией 1% от снимаемой суммы;");
      System.out.println("3) Для ИП, при пополнении счета будет взыскиваться комиссия в размере 1%, \n "
